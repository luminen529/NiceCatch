export const FAQ_ITEMS = [
  ...
  {
    question: '2026학년도에 달라진 글자수가 있나요?',
    answer:
      '있습니다. 진로활동 특기사항이 700자(2,100Byte)에서 500자(1,500Byte)로, 행동특성 및 종합의견이 500자(1,500Byte)에서 300자(900Byte)로 줄었습니다. 또한 일상생활 활동상황(1,000자 / 3,000Byte) 영역이 새로 생겼습니다. 공통과목의 세부능력 및 특기사항은 1·2를 합산해 500자 이내로 기재합니다.',
  },
  {
